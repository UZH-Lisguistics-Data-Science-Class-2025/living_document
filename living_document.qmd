...
#### Basic Syntax
Inline code is written as:  
`r R_EXPRESSION`  
Here, r indicates that the following expression should be executed using the R language.
...
It renders as:
Today is May 12, 2025 (*Today's Date*)
...
It renders as:
The average of the data is 47.2
