...
x <- "UZH-Lisguistics-Data-Science-Class-2025"
```
...
***Tasks for Code Cells are still under processing!!! @ZricGao***

### Inline Code

You can also include R code inline within your text using the syntax `` `r ` ``. This is useful for integrating computed values directly into your narrative.
For example, if you write: The sum of 10 and 20 is `` `r x + y` ``.
It will be rendered as: The sum of 10 and 20 is 30.
