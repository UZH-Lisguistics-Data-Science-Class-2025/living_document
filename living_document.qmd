...
As you know, Git is an amazing tool to work collaboratively on a project, but when it comes to making commits to the project, this can lead to some confusion. So here is a checklist when you want to preapre a commit for merging into the project:
  ...
  9. After doing so, click on ***Create pull request***. 
  10. Go back to *GitHub Desktop*, again click on the ***Branch*** dropdown menu, and select *Update from upstream/main* or use the shortcut Ctrl+Shift+U. Now you have to wait for your administrator to review your commits and merge it into the main document.  
