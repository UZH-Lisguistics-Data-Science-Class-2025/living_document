...
### Preparing commits
As you know, Git is an amazing tool to work collaboratively on a project, but when it comes to making a commit to the project, this can lead to some confusion. So here is a checklist when you want to preapre a commit for merging into the project:
  ...
  4. On the bottom left, you can now add a title and a description to your commit in a text field. Make sure to briefly but clearly describe what changes you have made. You can now commit your changes to your branch by clicking on the blue button under the text field ***Commit to branch_name***
  5. Now, it's time to pull/merge your commit into the main branch. If someone else is the administrator and has to check your commits for pulling, you need to click on *Preview pull request* under the ***Branch*** dropdown menu at the very top
  6. This opens a new window where you can view your commits and adjust the description or title of your commit if necessary. If everything's good, you can click on the blue button ***Create pull request*** on the bottom right
  7. A window pops up in which it asks you if you want to push your commit. You now have to click on ***Push commit***
  ...
  9. Now you have to wait for your administrator to review your commit and merge it into the main document.
