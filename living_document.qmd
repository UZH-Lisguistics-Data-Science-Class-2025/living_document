...
The metadata header is a section at the top of the document which provides information about it, and allows for customized formatting and rendering.

The formatting is applied only to the current document.

Use triple - to delineate the block:
