...
As you know, Git is an amazing tool to work collaboratively on a project, but when it comes to making commits to the project, this can lead to some confusion. So here is a checklist when you want to preapre a commit for merging into the project:
  ...
  4. On the bottom left, you can now add a title and a description to your commits in a text field. Make sure to briefly but clearly describe what changes you have made. You can now commit your changes to your branch by clicking on the blue button under the text field ***Commit to branch_name***
  ...
  8. This automatically redirects you to the web version of GitHub. Go back to *GitHub Desktop*, again click on the ***Branch*** dropdown menu, and select *Update from upstream/main* or use the shortcut Ctrl+Shift+U
  9. Now you have to wait for your administrator to review your commits and merge it into the main document.
